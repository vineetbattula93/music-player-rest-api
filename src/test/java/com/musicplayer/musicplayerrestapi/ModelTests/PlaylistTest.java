...
public class PlaylistTest {
	...
	public void removeSongFromPlaylistTest() {
		...
		assertEquals("Removing a song from a playlist should shorten the songlist by 1",5,myPlaylist.getSonglist().size());
		assertEquals("Removing a song from a playlist should remove only that song","Africa",myPlaylist.getSonglist().get(0).getTitle());
		assertEquals("Removing a song from a playlist should remove only that song","Take On Me",myPlaylist.getSonglist().get(1).getTitle());
	...
	public void moveSongTest() {
		...
		assertEquals("First song is correct","Take On Me",song0Title);
		assertEquals("Second song is correct","Africa",song1Title);
		assertEquals("Third song is correct","Africa",song2Title);

	}

	@Test
	public void getPlaylistDurationTest() {
		long expectedDurationSeconds = 1954;
	...
	public void showPlaylistTest() {
		String expectedPlaylist = myPlaylist.getSonglist().get(0).getTitle()+" - "+ myPlaylist.getSonglist().get(0).getArtist()+" "+myPlaylist.getSonglist().get(0).getDurationPretty()+"\n"+
				...
				myPlaylist.getSonglist().get(3).getTitle()+" - "+ myPlaylist.getSonglist().get(3).getArtist()+" "+myPlaylist.getSonglist().get(3).getDurationPretty()+"\n"+
				myPlaylist.getSonglist().get(4).getTitle()+" - "+ myPlaylist.getSonglist().get(4).getArtist()+" "+myPlaylist.getSonglist().get(4).getDurationPretty()+"\n"+
				myPlaylist.getSonglist().get(5).getTitle()+" - "+ myPlaylist.getSonglist().get(5).getArtist()+" "+myPlaylist.getSonglist().get(5).getDurationPretty()+"\n";
